Contributing to the Netuitive Rails Agent
======================================
...
### Reporting Bugs
Report bugs on [the issues page](https://github.com/Netuitive/netuitive_rails_agent/issues).
...
### Fixing bugs
Find bugs at [the issues page](https://github.com/Netuitive/netuitive_rails_agent/issues). Anything tagged with
...
Find features at [the issues page](https://github.com/Netuitive/netuitive_rails_agent/issues). Anything tagged
...
The Netuitive Rails Agent can always use documentation (more documentation is always better!). 
...
### Submitting Feedback
File an issue at [the issues page](https://github.com/Netuitive/netuitive_rails_agent/issues).
